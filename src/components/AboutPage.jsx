    ...
    <div>
      ...
      <div className="stat-strip">
        <div className="stat-strip__inner">
          {[{n:"2026",l:"Founded"},{n:"6",l:"Campaigns Planned"},{n:"Maharashtra",l:"Starting Region"},{n:"100%",l:"Donation Transparency"}].map(({n,l}) => (
            <div key={l}>
      ...
      <div className="vision-grid">
        {items.map(({ img, text }) => (
          <div key={text} className="about-card about-card--top-border">
            <div className="vision-icon"><img src={img} alt="" className="vision-icon__img" /></div>
            <p className="body-txt" style={{ marginBottom:0, fontSize:15 }}>{text}</p>
          </div>
        ))}
      </div>

      <div className="vision-quote-img">
...
function Mission() {
  ...
  return (
    <div>
      ...
      <div style={{ background:"#D4621A", padding:"64px 40px", textAlign:"center" }}>
        <p style={{ fontFamily:"'Playfair Display', serif", fontSize:"clamp(1.4rem,2.8vw,2rem)", fontWeight:700, color:"#fff", maxWidth:700, margin:"0 auto", lineHeight:1.4 }}>
      ...
      <div className="values-grid">
        {values.map(({ img, title, desc }) => (
          <div key={title} className="value-card">
            <div className="value-icon value-icon--img">
        ...
        <div className="models-list">
          {models.map(({ img, title, desc }) => (
            <div key={title} className="model-card">
              <div className="model-icon model-icon--img">
...
function WhyTrustUs() {
  ...
  return (
    <div className="about-section">
      ...
      <div className="trust-grid">
        {reasons.map(({ img, title, desc }) => (
          <div key={title} className="about-card">
            <div className="trust-icon trust-icon--img">
      ...
      <h2 className="sec-head sec-head--center" style={{ marginBottom:36 }}>What people say</h2>
